...
document.getElementById('parcelas-button').onclick = function()
{
    ...
    if (parcelasTable.style.display === 'block') {
        ...
        const precoFinal = 8941.16;
        const parcelas = [
            { num: 2, valorParcela: 4470.58},
            { num: 3, valorParcela: 2980.386666666667 },
            { num: 4, valorParcela: 2235.29 }, 
            { num: 5, valorParcela: 1788.232 },
            { num: 6, valorParcela: 1490.193333333333 },
            { num: 7, valorParcela: 1277.308571428571 },
            { num: 8, valorParcela: 1117.645 },
            { num: 9, valorParcela: 993.4622222222222 },
            { num: 10, valorParcela: 894.116 },
