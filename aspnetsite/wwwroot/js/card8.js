...
document.getElementById('parcelas-button').onclick = function()
{
    ...
    if (parcelasTable.style.display === 'block') {
        ...
        const precoFinal = 2336.93;
        const parcelas = [
            { num: 2, valorParcela: 1168.465 },
            { num: 3, valorParcela: 778.9766666666667 },
            { num: 4, valorParcela: 584.2325 }, 
            { num: 5, valorParcela: 467.386 },
            { num: 6, valorParcela: 389.4883333333333 },
            { num: 7, valorParcela: 333.8471428571429 },
            { num: 8, valorParcela: 292.11625 },
            { num: 9, valorParcela: 259.6588888888889 },
            { num: 10, valorParcela: 233.693 },
