...
document.getElementById('parcelas-button').onclick = function()
{
    ...
    if (parcelasTable.style.display === 'block') {
        ...
        const precoFinal = 2859;
        const parcelas = [
            { num: 2, valorParcela: 1429.5 },
            { num: 3, valorParcela: 953 },
            { num: 4, valorParcela: 714.75 }, 
            { num: 5, valorParcela: 571.8 },
            { num: 6, valorParcela: 476.5 },
            { num: 7, valorParcela: 408.4285714285714 },
            { num: 8, valorParcela: 357.375 },
            { num: 9, valorParcela: 317.6666666666667 },
            { num: 10, valorParcela: 285.9 },
