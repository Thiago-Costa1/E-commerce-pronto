...
document.getElementById('parcelas-button').onclick = function()
{
    ...
    if (parcelasTable.style.display === 'block') {
        ...
        const precoFinal = 16949.00;
        const parcelas = [
            { num: 2, valorParcela: 8474.5 },
            { num: 3, valorParcela: 5649.666666666667 },
            { num: 4, valorParcela: 4237.25 }, 
            { num: 5, valorParcela: 3389.8 },
            { num: 6, valorParcela: 2824.833333333333 },
            { num: 7, valorParcela: 2421.285714285714 },
            { num: 8, valorParcela: 2118.625 },
            { num: 9, valorParcela: 1883.222222222222 },
            { num: 10, valorParcela: 1694.9 },
