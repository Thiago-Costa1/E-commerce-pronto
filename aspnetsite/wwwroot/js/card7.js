...
document.getElementById('parcelas-button').onclick = function()
{
    ...
    if (parcelasTable.style.display === 'block') {
        ...
        const precoFinal = 2549.90;
        const parcelas = [
            { num: 2, valorParcela: 1274.95 },
            { num: 3, valorParcela: 849.9666666666667 },
            { num: 4, valorParcela: 637.475 }, 
            { num: 5, valorParcela: 509.98 },
            { num: 6, valorParcela: 424.9833333333333 },
            { num: 7, valorParcela: 364.2714285714286 },
            { num: 8, valorParcela: 318.7375 },
            { num: 9, valorParcela: 283.3222222222222 },
            { num: 10, valorParcela: 254.99 },
