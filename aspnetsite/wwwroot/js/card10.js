...
document.getElementById('parcelas-button').onclick = function()
{
    ...
    if (parcelasTable.style.display === 'block') {
        ...
        const precoFinal = 15299.00;
        const parcelas = [
            { num: 2, valorParcela: 7649.5 },
            { num: 3, valorParcela: 5099.666666666667 },
            { num: 4, valorParcela: 3824.75 }, 
            { num: 5, valorParcela: 3059.8 },
            { num: 6, valorParcela: 2549.833333333333 },
            { num: 7, valorParcela: 2185.571428571429 },
            { num: 8, valorParcela: 1912.375 },
            { num: 9, valorParcela: 1699.888888888889 },
            { num: 10, valorParcela: 1529.9 },
