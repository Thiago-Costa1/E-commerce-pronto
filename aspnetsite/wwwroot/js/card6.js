...
document.getElementById('parcelas-button').onclick = function()
{
    ...
    if (parcelasTable.style.display === 'block') {
        ...
        const precoFinal = 2089.05;
        const parcelas = [
            { num: 2, valorParcela: 1044.525 },
            { num: 3, valorParcela: 696.35},
            { num: 4, valorParcela: 522.2625 }, 
            { num: 5, valorParcela: 417.81 },
            { num: 6, valorParcela: 348.175 },
            { num: 7, valorParcela: 298.4357142857143 },
            { num: 8, valorParcela: 261.13125 },
            { num: 9, valorParcela: 232.1166666666667 },
            { num: 10, valorParcela: 208.905 },
